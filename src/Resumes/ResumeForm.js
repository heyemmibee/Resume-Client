        ...
        <div>
                            ...
                            <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                <div className="grid grid-cols-6 gap-6">
                                    <div className="col-span-6 sm:col-span-3">
                                        <label for="pronoun" className="block text-sm font-medium text-gray-700">Pronoun</label>
            ...
            <div className="mt-10 sm:mt-0">
                <div className="md:grid md:grid-cols-3 md:gap-6">
                    <div className="md:col-span-1">
                        <div className="px-4 sm:px-0">
                            <h3 className="text-lg font-medium leading-6 text-gray-900">Career Links</h3>
                                ...
                                <div className="px-4 py-5 bg-white sm:p-6">
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-4">
                                            <label for="headline" className="block text-sm font-medium text-gray-700">Headline</label>
                                        ...
                                        <div className="col-span-6 sm:col-span-4">
                                            <label for="summary" className="block text-sm font-medium text-gray-700">Summary</label>
